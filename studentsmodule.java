...
public class studentsmodule extends javax.swing.JFrame {
    ...
    public studentsmodule() {
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("schoolmanagementsystem/schoo.jpg"));
        
        // Create the JLabel with the image
        JLabel imageLabel = new JLabel(i1);
        
        // Set the preferred size for the label (fixed size)
        imageLabel.setPreferredSize(new Dimension(10000, 10000)); // Set your fixed size here
